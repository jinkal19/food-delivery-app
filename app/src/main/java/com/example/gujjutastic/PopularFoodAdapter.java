...
public class PopularFoodAdapter<getApplicationContext> extends RecyclerView.Adapter<PopularFoodAdapter.PopularFoodViewHolder> {
    ...
    public void onBindViewHolder(@NonNull PopularFoodViewHolder holder, int position) {
        ...
        holder.price.setText(String.valueOf(popularFoodList.get(position).getPrice()));
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                i.putExtra("imageUrl",temp.getImageUrl());
